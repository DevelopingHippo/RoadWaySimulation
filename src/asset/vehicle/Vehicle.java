...
public class Vehicle extends Asset {
    ...
    public void generateSmokeAnimation() {
        ParticleAnimation smokeAnimation = new ParticleAnimation(simMain, this, 288);
    ...
    public Vehicle(SimulationMain simMain) {
        ...
        setup();
        collisionBox = new Rectangle(10, 25, simMain.tileSize, simMain.tileSize);
    }



    public void update() {
        vehicleSimulation.simulate();
